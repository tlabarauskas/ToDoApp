...
public class TaskArrayAdapter extends ArrayAdapter<ProjectTask> {
    ...
    public TaskArrayAdapter(@NonNull Context context, int resource, @NonNull ArrayList<ProjectTask> objects) {
